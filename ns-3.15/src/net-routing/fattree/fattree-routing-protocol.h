#ifndef __FATTREE_ROUTING_PROTOCOL__
#define __FATTREE_ROUTING_PROTOCOL__
...
{
	class Packet;
	class FattreeRoutingProtocol : public NetRoutingProtocol
	{
		uint32_t m_n;
	...
	public:
		...
		virtual uint32_t GetPathNumber() const;
