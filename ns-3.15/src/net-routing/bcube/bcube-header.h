#ifndef __BCUBE_HEADER__
#define __BCUBE_HEADER__
...
namespace ns3
{
	class BCubeHeader : public NetHeader
	{
		uint8_t m_protocol;
	...
	public:
        ...
        std::vector< uint32_t > GetPath() const { return m_path; }
        ...
        void SetPath(std::vector< uint32_t > path) { m_path = path; }
