...
private:
	...
	uint32_t m_usedIngressPGMinBytes[pCnt][qCnt];
	uint32_t m_usedIngressPortMinBytes[pCnt];
	uint32_t m_usedIngressSPBytes[4];
	uint32_t m_usedIngressSPSharedBytes;
	uint32_t m_usedIngressPGSharedBytes[pCnt][qCnt];
	uint32_t m_usedIngressPortSharedBytes[pCnt];

	uint32_t m_usedIngressPGMinExceed[pCnt][qCnt];
	uint32_t m_usedIngressPortMinExceed[pCnt];
	uint32_t m_usedIngressSPExceed[4];
	uint32_t m_usedIngressSPSharedExceed;
	uint32_t m_usedIngressPGSharedExceed[pCnt][qCnt];
	uint32_t m_usedIngressPortSharedExceed[pCnt];
